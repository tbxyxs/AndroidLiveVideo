...
public class TextureFilter extends AbsFilter {
    ...
    public void draw() {
        ...
        GLShaderHelper.bindFrameTexture(fFrame[0], fTexture[0]);
        GLES20.glViewport(0, 0, width, height);
        mFilter.setTextureId(mCameraTexture[0]);
        mFilter.draw();
        GLShaderHelper.unBindFrameBuffer();
    ...
    protected void onSizeChanged(int width, int height) {
        ...
        if (this.width != width || this.height != height) {
            ...
            GLShaderHelper.genTexturesWithParameter(1, fTexture, 0, GLES20.GL_RGBA, width, height);
        }
    }
